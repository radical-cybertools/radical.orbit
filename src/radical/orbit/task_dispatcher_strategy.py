...
- Entry-point name — matches a registered entry point in the
  ``radical.orbit.task_dispatcher.strategies`` group.
...
ENTRY_POINT_GROUP = 'radical.orbit.task_dispatcher.strategies'
...
def load_strategy(spec: str,
    ...
    3. Else, look up in the
       ``radical.orbit.task_dispatcher.strategies`` entry-point group
